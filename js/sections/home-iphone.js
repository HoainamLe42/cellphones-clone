...
export async function loadIphoneSection() {
    const container = document.getElementById('section-iphone');
    if (!container) return;
    ...
    async function getProducts() {
        const res = await fetch(`http://localhost:8000/products?brand=iPhone&_limit=5`);
